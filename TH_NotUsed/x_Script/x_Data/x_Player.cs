...
public class x_Player
{
    ...
    public static void Test()
    {
        ...
        //}
        memberCombos[x_IDxUNIT.ATAHO][0] = 1; //돌려차기
        memberCombos[x_IDxUNIT.ATAHO][1] = 4; //호격권

        x_UnitMgr.Test_SetMyPC();

        for (int i = 0; i < x_DataMgr.ItemTBL.Count; i++)
            Items.Add(new Item(x_DataMgr.ItemTBL[i], Random.Range(0, 3)));
    }
}