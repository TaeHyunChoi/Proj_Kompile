...
public class x_CameraMgr
{
    ...
    public static Vector3 Battle_ScreenToLocalInRect(Vector3 targetPos)
    {
        ...
        RectTransformUtility.ScreenPointToLocalPointInRectangle(x_UIMgr.Canvas_Battle.GetComponent<RectTransform>(), screenPoint, battleCam, out Vector2 localPoint);
        return localPoint;
    }
}
