namespace Kompile.Data
{
    ...
    public struct ActorIntent
    {
        ...
        /// <summary> 트리거성 애니메이션 명령. None이면 AnimComponent가 무시 </summary>
        public EntityState State;

        public ActorIntent(Vector3 dir, EntityState anim)
        {
            MoveInput = dir;
            State = anim;
        }
