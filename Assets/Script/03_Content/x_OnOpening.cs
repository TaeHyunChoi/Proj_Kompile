...
public class x_OnOpening : ISequenceUpdater
{
    //Inherit: ContentOpening
    private class OpeningLogo : x_ContentOpening
    {
    ...
    private class OpeningDemo : x_ContentOpening
    {
        public override void Begin()
        {
            canSkip = true;
    ...
    private class OpeningTitle : x_ContentOpening
    {
    ...
    private static x_OnOpening instance;

    private x_ContentOpening   current;
    private GameObject       gameObject;
    private Transform        transform;
    private int state;

    public static async Task<x_OnOpening> InitAsync(Transform canvas_ui)
    {
        if (instance != null)
        {
            return null;
    ...
    public x_OnOpening(GameObject go)
    {
        gameObject = go;
    ...
    public void MoveNext()
    {
        ...
        {
            case 0:
                current = transform.GetChild(0).gameObject.AddComponent<OpeningLogo>();
                (current as OpeningLogo).Begin();
                break;
            case 1:
                current = transform.GetChild(1).gameObject.AddComponent<OpeningDemo>();
                (current as OpeningDemo).Begin();         
                break;
            case 2:
                current = transform.GetChild(2).gameObject.AddComponent<OpeningTitle>();
                (current as OpeningTitle).Begin();
                break;
            case 3:
