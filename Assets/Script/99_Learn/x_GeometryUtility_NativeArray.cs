...
/// <summary>
/// 충돌 감지를 하고자 Job System으로 구현했으나, 프로파일링 결과 오버헤드가 확인되어 폐기
/// List<T>로 구현하면 대략 15-20ms 가 나오는데, Job System으로 하니 25ms 전후가 나옴
/// </summary>
public class x_GeometryUtility_NativeArray : MonoBehaviour
{
    ...
    public bool CanMove(Dictionary<int, Tile_t> map, Vector3 dir, out Vector3 goal)
    {
        ...
        //어쩌다 이렇게 되었는가ㅠ..
        //오히려 오버헤드가 걸리고 있는 것 같다? 프레임이 이렇게 떨어지다니
