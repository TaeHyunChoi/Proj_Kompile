...
public struct EditMapLinkJob : IJobParallelFor
{
    ...
    public void Execute(int index)
    {
        ...
        for (int i = 0; i < LinkDirs.Length; i++)
        {
            ...
            MapConsts.EditMapTileDirFlag dirFlag = MapNaviTileUtil.GetDirFlag(dir2D.x, dir2D.y);
    ...
    private readonly bool CheckConnectable(EditMapTileData myTile, EditMapTileData neighborTile, float3 dir, MapConsts.EditMapTileDirFlag dirFlag)
    {
        // 직선 방향 체크
