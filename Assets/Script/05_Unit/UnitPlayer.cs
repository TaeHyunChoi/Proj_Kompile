...
public class UnitPlayer : UnitBase
{
    ...
    public void Move(Dictionary<int, Tile_t> map, Vector3 dirInput, float scale)
    {
        ...
        for (int d = 0; d < 5; ++d)
        {
            ...
            dirRotated = CMath.FloorToVector(dirRotated * (SIZE_QUATER + dist), 3);
            ...
            for (int c = 0; c < 3; ++c)
            {
                ...
                dirCollide = CMath.FloorToVector(dirCollide * (SIZE_QUATER + dist), 3);
    ...
    SET_POSITION:
        ...
        Vector3 pointGoal = CMath.FloorToVector(pointNow + dirInput, 3);
