...
public partial class TitleObject : MonoBehaviour, /*IngameMonoBehaviourBase,*/ IIngameUpdater, IInputReceiver
{
    ...
    public IngameUpdateState UpdateState()
    {
        ...
        //    default:
        //        MessageManager.Publish(new OnEndEvent(IngameEventType.OPENING_INSTANTIATE_TITLE));
        //        enabled = false;
