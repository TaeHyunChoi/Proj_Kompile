    ...
    public struct EditMapLinkJobUtil : IJobParallelFor
    {
        ...
        public void Execute(int index)
        {
            ...
            for (int i = 0; i < LinkDirs.Length; ++i)
            {
                ...
                EditMapConsts.EditMapTileDirFlag dirFlag = EditMapNaviTileUtil.GetDirFlag(linkDir.x, linkDir.y);
        ...
        private readonly bool CheckConnectable(long neighborTileID, EditMapTileData myTile, EditMapConsts.EditMapTileDirFlag dirFlag)
        {
            ...
            EditMapConsts.EditMapTileDirFlag first = dirFlag & (EditMapConsts.EditMapTileDirFlag.LEFT | EditMapConsts.EditMapTileDirFlag.RIGHT);
            EditMapConsts.EditMapTileDirFlag second = dirFlag & (EditMapConsts.EditMapTileDirFlag.UP | EditMapConsts.EditMapTileDirFlag.DOWN);

            return IsChainLinked(myTile, neighborTile, first, second) &&
                   IsChainLinked(myTile, neighborTile, second, first);
        }

        private readonly bool IsSingleDirection(EditMapConsts.EditMapTileDirFlag dirFlag)
        {
            int count = 0;
            if (0 != (dirFlag & EditMapConsts.EditMapTileDirFlag.LEFT)) { count += 1; }

            if (0 != (dirFlag & EditMapConsts.EditMapTileDirFlag.RIGHT)) { count += 1; }

            if (0 != (dirFlag & EditMapConsts.EditMapTileDirFlag.UP)) { count += 1; }

            if (0 != (dirFlag & EditMapConsts.EditMapTileDirFlag.DOWN)) { count += 1; }

            return count == 1;
        }

        private readonly bool IsSingleLinked(EditMapConsts.EditMapTileDirFlag direction, EditMapTileData myTile,
            EditMapTileData neighborTile)
        {
            ...
            {
                EditMapConsts.EditMapTileDirFlag.LEFT => EditMapConsts.EditMapTileDirFlag.RIGHT,
                EditMapConsts.EditMapTileDirFlag.RIGHT => EditMapConsts.EditMapTileDirFlag.LEFT,
                EditMapConsts.EditMapTileDirFlag.UP => EditMapConsts.EditMapTileDirFlag.DOWN,
                EditMapConsts.EditMapTileDirFlag.DOWN => EditMapConsts.EditMapTileDirFlag.UP,
        ...
        private readonly bool IsChainLinked(EditMapTileData startTile, EditMapTileData targetTile,
            EditMapConsts.EditMapTileDirFlag first,
            EditMapConsts.EditMapTileDirFlag second)
        {
