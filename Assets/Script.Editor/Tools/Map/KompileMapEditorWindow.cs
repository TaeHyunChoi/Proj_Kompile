    ...
    private void OnGUI()
    {
        ...
        switch (_currentMode)
        {
            ...
            case EditMode.Add:
                ...
                _samplingRoot = (EditMapSamplingComponent)EditorGUILayout.ObjectField("Sampling Root", _samplingRoot,
                    typeof(EditMapSamplingComponent), true);
                break;
            case EditMode.Height:
                _currentSelection =
                    (SelectionMode)GUILayout.Toolbar((int)_currentSelection, new string[] { "Vertex", "Face" }); break;
        }
