...
namespace Kompile.Map.Editor.Data
{
    ...
    {
        [Key(0)] public int gridKey;

        [Key(1)] public ConcurrentDictionary<int, EditMapTileData> Data;

        [Key(2)] public List<string> assetFiles;

        [Key(3)] public List<MapGridLayerData> LayerMeshAssets = new List<MapGridLayerData>();
