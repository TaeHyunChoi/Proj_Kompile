namespace Kompile.Map.Editor.Entity
{
    ...
    public class EditMapTileComponent : MonoBehaviour
    {
        ...
        [Header("Render")] [SerializeField] private MeshFilter meshFilter;
        ...
        [SerializeField]
        private Texture2D topAtlasTexture;
        ...
        [Header("Data")] [SerializeField] private ulong heightMask;
        ...
        public void UpdateMesh(sbyte[] neighborHeights)
        {
            ...
            Mesh newMesh = EditMapMeshUtil.GenerateMesh(heightData, neighborHeights);
        ...
        {
            float y = (heightData[index] == -1) ? 0f : (heightData[index] * EditMapMeshUtil.HeightStep);
        ...
        private void FillNeighborHeights(sbyte[] nh, int startSeg, Dictionary<Vector2Int, EditMapTileComponent> map,
            Vector2Int nPos, int nV1, int nV2, int nV3)
        {
