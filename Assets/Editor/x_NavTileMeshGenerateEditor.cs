...
[System.Obsolete]
public class x_NavTileMeshGenerateEditor : MonoBehaviour
{
    /*
    ...
    public static void GenerateNavTileMesh_CubeDefault()
    {
        ...
        mesh.vertices = new []
        {
             ...
             new Vector3(0f, -1f, 0f), new Vector3(1f, -1f, 0f), new Vector3(1f, -1f, 1f),
             new Vector3(0f, -1f, 0f), new Vector3(1f, -1f, 1f), new Vector3(0f, -1f, 1f),
        };
