namespace Script.Data
{
    ...
    [MessagePackObject]
    public partial class x_ConcurrentDictionary<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>> 
    {
        [Serializable]
        ...
        public x_ConcurrentDictionary()
        {
            _dictionary = new Dictionary<TKey, TValue>();
        }
        public x_ConcurrentDictionary(Dictionary<TKey, TValue> dictionary)
        {
