...
public class x_IngameMapGridObject : MonoBehaviour //:IngameMonoBehaviourBase
{
    ...
    public async void Initialize(MapGridData data)
    {
        ...
        //by_layer_objects = new List<x_IngameMapGridLayerObject>();
        ...
        //    {
        //        var layer_obj = await AssetManager.GetOrNewInstanceAsync<x_IngameMapGridLayerObject>(AssetCode.MapGridLayerPrefab, this.transform, usePooling: true);
