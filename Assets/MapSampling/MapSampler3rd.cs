...
//    private Dictionary<int, Voxel_t3> data;
...
//    {
//        data = new Dictionary<int, Voxel_t3>();
...
//                if (!data.TryGetValue(idxNeighbor, out Voxel_t3 neighbor)
...
//            {
//                data[index] = new Voxel_t3(voxel.Data & ~(0xFF));
//            }
//        }
//    }
...
//            data[index] = new Voxel_t3(data[index].Data & ~blocked);
//        }
//    }
...
//        if (!data.TryGetValue(index, out Voxel_t3 voxel))
//        {
//            data.Add(index, new Voxel_t3(objectType, (int)targetType, movable));
//            return;
//        }
...
//        data[index] = new Voxel_t3(objectType, (int)targetType, movable);
//    }
...
//                {
//                    if (data[index].ObjectType != VoxelType.Slope45)
//                    {
//                        Gizmos.color = new Color(0, 1, 0, gizmoAlpha[0]);
//                    }
//                    else
//                    {
//                        Gizmos.color = new Color(0, 0, 1, gizmoAlpha[0]);
//                    }
//                }
//                else
//                {
